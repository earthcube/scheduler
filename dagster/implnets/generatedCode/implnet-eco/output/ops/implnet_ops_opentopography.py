...
@op
def opentopography_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "opentopography")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def opentopography_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "opentopography")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def opentopography_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "opentopography")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def opentopography_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "opentopography")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def harvest_opentopography():
    harvest = opentopography_gleaner()
    #report1 =opentopography_missingreport_s3(harvest)
    report1 = opentopography_missingreport_s3(harvest)
    load1 = opentopography_nabu(harvest)
    load2 = opentopography_nabuprov(load1)
    load3 = opentopography_nabuorg(load2)
    load4 = opentopography_naburelease(load3)
