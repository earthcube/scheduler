...
def harvest_opentopography():
    ...
    load1 = opentopography_nabu_prune(harvest)
    load2 = opentopography_nabuprov(load1)
    load3 = opentopography_nabuorg(load2)
    load4 = opentopography_naburelease(load3)
    load5 = opentopography_uploadrelease(load4)
    report2=opentopography_missingreport_graph(load5)
    report3=opentopography_graph_reports(report2)
