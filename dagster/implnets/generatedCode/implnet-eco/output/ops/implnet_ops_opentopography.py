...
def harvest_opentopography():
    ...
    load_uploadrelease = opentopography_uploadrelease(load_release)

    load_prune = opentopography_nabu_prune(load_uploadrelease)
    load_prov = opentopography_nabuprov(load_prune)
    load_org = opentopography_nabuorg(load_prov)

# run after load
    report_msgraph=opentopography_missingreport_graph(load_org)
    report_graph=opentopography_graph_reports(report_msgraph)
