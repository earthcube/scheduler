...
def harvest_neotomadb():
    ...
    load_uploadrelease = neotomadb_uploadrelease(load_release)

    load_prune = neotomadb_nabu_prune(load_uploadrelease)
    load_prov = neotomadb_nabuprov(load_prune)
    load_org = neotomadb_nabuorg(load_prov)

# run after load
    report_msgraph=neotomadb_missingreport_graph(load_org)
    report_graph=neotomadb_graph_reports(report_msgraph)
