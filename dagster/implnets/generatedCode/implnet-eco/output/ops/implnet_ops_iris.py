...
def iris_gleaner(context):
    returned_value = gleanerio(("gleaner"), "iris")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def iris_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "iris")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def iris_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "iris")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def iris_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "iris")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def iris_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "iris")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
