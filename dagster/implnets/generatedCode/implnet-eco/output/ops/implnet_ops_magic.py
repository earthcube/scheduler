...
def harvest_magic():
    ...
    load1 = magic_nabu_prune(harvest)
    load2 = magic_nabuprov(load1)
    load3 = magic_nabuorg(load2)
    load4 = magic_naburelease(load3)
    load5 = magic_uploadrelease(load4)
    report2=magic_missingreport_graph(load5)
    report3=magic_graph_reports(report2)
