...
def harvest_ssdbiodp():
    ...
    report1 =ssdbiodp_missingreport_s3(harvest)
    #report1 = missingreport_s3(harvest, source="ssdbiodp")
    load1 = ssdbiodp_nabu_prune(harvest)
    load2 = ssdbiodp_nabuprov(load1)
    load3 = ssdbiodp_nabuorg(load2)
    load4 = ssdbiodp_naburelease(load3)
    load5 = ssdbiodp_uploadrelease(load4)
    report2=ssdbiodp_missingreport_graph(load5)
    report3=ssdbiodp_graph_reports(report2)
