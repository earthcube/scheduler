...
def harvest_ssdbiodp():
    ...
    load_uploadrelease = ssdbiodp_uploadrelease(load_release)

    load_prune = ssdbiodp_nabu_prune(load_uploadrelease)
    load_prov = ssdbiodp_nabuprov(load_prune)
    load_org = ssdbiodp_nabuorg(load_prov)

# run after load
    report_msgraph=ssdbiodp_missingreport_graph(load_org)
    report_graph=ssdbiodp_graph_reports(report_msgraph)
