...
def harvest_hydroshare():
    ...
    load_uploadrelease = hydroshare_uploadrelease(load_release)

    load_prune = hydroshare_nabu_prune(load_uploadrelease)
    load_prov = hydroshare_nabuprov(load_prune)
    load_org = hydroshare_nabuorg(load_prov)

# run after load
    report_msgraph=hydroshare_missingreport_graph(load_org)
    report_graph=hydroshare_graph_reports(report_msgraph)
