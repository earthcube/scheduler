...
def harvest_hydroshare():
    ...
    load1 = hydroshare_nabu_prune(harvest)
    load2 = hydroshare_nabuprov(load1)
    load3 = hydroshare_nabuorg(load2)
    load4 = hydroshare_naburelease(load3)
    load5 = hydroshare_uploadrelease(load4)
    report2=hydroshare_missingreport_graph(load5)
    report3=hydroshare_graph_reports(report2)
