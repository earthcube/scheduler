...
def harvest_earthchem():
    ...
    load_uploadrelease = earthchem_uploadrelease(load_release)

    load_prune = earthchem_nabu_prune(load_uploadrelease)
    load_prov = earthchem_nabuprov(load_prune)
    load_org = earthchem_nabuorg(load_prov)

# run after load
    report_msgraph=earthchem_missingreport_graph(load_org)
    report_graph=earthchem_graph_reports(report_msgraph)
