...
def harvest_geocodes_demo_datasets():
    ...
    load1 = geocodes_demo_datasets_nabu_prune(harvest)
    ...
    load5 = geocodes_demo_datasets_uploadrelease(load4)
    report2=geocodes_demo_datasets_missingreport_graph(load5)
    report3=geocodes_demo_datasets_graph_reports(report2)
