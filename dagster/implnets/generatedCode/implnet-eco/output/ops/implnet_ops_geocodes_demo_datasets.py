...
def harvest_geocodes_demo_datasets():
    ...
    load_uploadrelease = geocodes_demo_datasets_uploadrelease(load_release)

    load_prune = geocodes_demo_datasets_nabu_prune(load_uploadrelease)
    load_prov = geocodes_demo_datasets_nabuprov(load_prune)
    load_org = geocodes_demo_datasets_nabuorg(load_prov)

# run after load
    report_msgraph=geocodes_demo_datasets_missingreport_graph(load_org)
    report_graph=geocodes_demo_datasets_graph_reports(report_msgraph)
