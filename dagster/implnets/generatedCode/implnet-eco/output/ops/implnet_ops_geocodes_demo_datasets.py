...
def geocodes_demo_datasets_upload_summarize(context):
    returned_value = post_to_graph("geocodes_demo_datasets",path=SUMMARY_PATH, extension="nt", graphendpoint=_graphSummaryEndpoint())
    r = str('returned value:{}'.format(returned_value))
...
# run after load
    ...
    report_msgraph=geocodes_demo_datasets_missingreport_graph(start=load_org)
    report_graph=geocodes_demo_datasets_graph_reports(start=report_msgraph)
