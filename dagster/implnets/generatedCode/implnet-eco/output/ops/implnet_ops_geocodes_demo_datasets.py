...
def geocodes_demo_datasets_gleaner(context):
    returned_value = gleanerio(("gleaner"), "geocodes_demo_datasets")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def geocodes_demo_datasets_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "geocodes_demo_datasets")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def geocodes_demo_datasets_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "geocodes_demo_datasets")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def geocodes_demo_datasets_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "geocodes_demo_datasets")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def geocodes_demo_datasets_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "geocodes_demo_datasets")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
...
def geocodes_demo_datasets_missingreport_s3(context, msg: str):
    ...
    source_url="geocodes_demo_datasets"
...
def harvest_geocodes_demo_datasets():
    harvest = geocodes_demo_datasets_gleaner()
    #report1 =geocodes_demo_datasets_missingreport_s3(harvest)
    report1 = geocodes_demo_datasets_missingreport_s3(harvest)
    load1 = geocodes_demo_datasets_nabu(harvest)
    load2 = geocodes_demo_datasets_nabuprov(load1)
    load3 = geocodes_demo_datasets_nabuorg(load2)
    load4 = geocodes_demo_datasets_naburelease(load3)
