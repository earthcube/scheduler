...
def harvest_designsafe():
    ...
    load1 = designsafe_nabu_prune(harvest)
    load2 = designsafe_nabuprov(load1)
    load3 = designsafe_nabuorg(load2)
    load4 = designsafe_naburelease(load3)
    load5 = designsafe_uploadrelease(load4)
    report2=designsafe_missingreport_graph(load5)
    report3=designsafe_graph_reports(report2)
