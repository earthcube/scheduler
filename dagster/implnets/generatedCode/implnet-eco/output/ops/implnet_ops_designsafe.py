...
def harvest_designsafe():
    ...
    load_uploadrelease = designsafe_uploadrelease(load_release)

    load_prune = designsafe_nabu_prune(load_uploadrelease)
    load_prov = designsafe_nabuprov(load_prune)
    load_org = designsafe_nabuorg(load_prov)

# run after load
    report_msgraph=designsafe_missingreport_graph(load_org)
    report_graph=designsafe_graph_reports(report_msgraph)
