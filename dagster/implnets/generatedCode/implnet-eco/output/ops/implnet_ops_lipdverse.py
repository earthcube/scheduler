...
def harvest_lipdverse():
    ...
    load_uploadrelease = lipdverse_uploadrelease(load_release)

    load_prune = lipdverse_nabu_prune(load_uploadrelease)
    load_prov = lipdverse_nabuprov(load_prune)
    load_org = lipdverse_nabuorg(load_prov)

# run after load
    report_msgraph=lipdverse_missingreport_graph(load_org)
    report_graph=lipdverse_graph_reports(report_msgraph)
