...
def lipdverse_gleaner(context):
    returned_value = gleanerio(("gleaner"), "lipdverse")
    r = str('returned value:{}'.format(returned_value))
    get_dagster_logger().info(f"Gleaner notes are  {r} ")
    return r

@op
def lipdverse_nabu(context, msg: str):
    returned_value = gleanerio(("nabu"), "lipdverse")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def lipdverse_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "lipdverse")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def lipdverse_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "lipdverse")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def lipdverse_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "lipdverse")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
