...
def harvest_bcodmo():
    ...
    report1 =bcodmo_missingreport_s3(harvest)
    #report1 = missingreport_s3(harvest, source="bcodmo")
    load1 = bcodmo_nabu_prune(harvest)
    load2 = bcodmo_nabuprov(load1)
    load3 = bcodmo_nabuorg(load2)
    load4 = bcodmo_naburelease(load3)
    load5 = bcodmo_uploadrelease(load4)
    report2=bcodmo_missingreport_graph(load5)
    report3=bcodmo_graph_reports(report2)
