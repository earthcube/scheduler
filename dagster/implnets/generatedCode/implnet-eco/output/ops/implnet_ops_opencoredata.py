...
def harvest_opencoredata():
    ...
    load_uploadrelease = opencoredata_uploadrelease(load_release)

    load_prune = opencoredata_nabu_prune(load_uploadrelease)
    load_prov = opencoredata_nabuprov(load_prune)
    load_org = opencoredata_nabuorg(load_prov)

# run after load
    report_msgraph=opencoredata_missingreport_graph(load_org)
    report_graph=opencoredata_graph_reports(report_msgraph)
