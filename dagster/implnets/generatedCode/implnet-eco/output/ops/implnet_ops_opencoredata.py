...
def harvest_opencoredata():
    ...
    load1 = opencoredata_nabu_prune(harvest)
    load2 = opencoredata_nabuprov(load1)
    load3 = opencoredata_nabuorg(load2)
    load4 = opencoredata_naburelease(load3)
    load5 = opencoredata_uploadrelease(load4)
    report2=opencoredata_missingreport_graph(load5)
    report3=opencoredata_graph_reports(report2)
