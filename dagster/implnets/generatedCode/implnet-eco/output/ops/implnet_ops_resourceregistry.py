...
def harvest_resourceregistry():
    ...
    load_uploadrelease = resourceregistry_uploadrelease(load_release)

    load_prune = resourceregistry_nabu_prune(load_uploadrelease)
    load_prov = resourceregistry_nabuprov(load_prune)
    load_org = resourceregistry_nabuorg(load_prov)

# run after load
    report_msgraph=resourceregistry_missingreport_graph(load_org)
    report_graph=resourceregistry_graph_reports(report_msgraph)
