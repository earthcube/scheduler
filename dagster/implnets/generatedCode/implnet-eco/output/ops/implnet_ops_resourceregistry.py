...
def resourceregistry_nabuprov(context, msg: str):
    returned_value = gleanerio(("prov"), "resourceregistry")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def resourceregistry_nabuorg(context, msg: str):
    returned_value = gleanerio(("orgs"), "resourceregistry")
    r = str('returned value:{}'.format(returned_value))
    return msg + r

@op
def resourceregistry_naburelease(context, msg: str):
    returned_value = gleanerio(("release"), "resourceregistry")
    r = str('returned value:{}'.format(returned_value))
    return msg + r
