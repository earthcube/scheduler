...
def harvest_neon():
    ...
    report1 =neon_missingreport_s3(harvest)
    #report1 = missingreport_s3(harvest, source="neon")
    load1 = neon_nabu_prune(harvest)
    load2 = neon_nabuprov(load1)
    load3 = neon_nabuorg(load2)
    load4 = neon_naburelease(load3)
    load5 = neon_uploadrelease(load4)
    report2=neon_missingreport_graph(load5)
    report3=neon_graph_reports(report2)
