...
def harvest_linkedearth():
    ...
    load_uploadrelease = linkedearth_uploadrelease(load_release)

    load_prune = linkedearth_nabu_prune(load_uploadrelease)
    load_prov = linkedearth_nabuprov(load_prune)
    load_org = linkedearth_nabuorg(load_prov)

# run after load
    report_msgraph=linkedearth_missingreport_graph(load_org)
    report_graph=linkedearth_graph_reports(report_msgraph)
