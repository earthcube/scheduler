...
MODULE_PATH = (
    Path(__file__).resolve().parents[1] / "ingest" / "long_running_run_alerts.py"
)
SPEC = spec_from_file_location("long_running_run_alerts", MODULE_PATH)
long_running_run_alerts = module_from_spec(SPEC)
assert SPEC.loader is not None
SPEC.loader.exec_module(long_running_run_alerts)
